...
goog.require=function(a){if(!COMPILED&&!goog.isProvided_(a)){if(goog.ENABLE_DEBUG_LOADER){var b=goog.getPathFromDeps_(a);if(b){goog.included_[b]=!0;goog.writeScripts_();return}}a="goog.require could not find: "+a;goog.global.console&&goog.global.console.error(a);throw Error(a);}};goog.basePath="";goog.global.CLOSURE_IMPORT_SCRIPT=null;goog.nullFunction=function(){};goog.identityFunction=function(a,b){return a};goog.abstractMethod=function(){throw Error("unimplemented abstract method");};
...
goog.scope=function(a){a.call(goog.global)};var sre={SystemExternal:function(){}};sre.SystemExternal.locationSupported=function(){return"undefined"!=typeof location};sre.SystemExternal.url=sre.SystemExternal.locationSupported()?location.protocol+"//mathjax.github.io/MathJax-accessibility/dist":"https://mathjax.github.io/MathJax-accessibility/dist";
sre.SystemExternal.jsonPath=function(){return("undefined"!==typeof process&&"undefined"!==typeof global?process.env.SRE_JSON_PATH||global.SRE_JSON_PATH||process.cwd():sre.SystemExternal.url+"/mathmaps")+"/"}();sre.SystemExternal.WGXpath=sre.SystemExternal.url+"/wgxpath.install.js";sre.SystemExternal.require=function(a){return"undefined"!==typeof require?require(a):null};sre.SystemExternal.documentSupported=function(){return"undefined"!=typeof document};
...
sre.AbstractHighlighter.prototype.setState=function(a,b){this.state_[a]=b};sre.AbstractHighlighter.prototype.getState=function(a){return this.state_[a]};sre.SvgHighlighter=function(){sre.AbstractHighlighter.call(this);this.mactionName="mjx-svg-maction"};goog.inherits(sre.SvgHighlighter,sre.AbstractHighlighter);
...
sre.SvgHighlighter.prototype.unhighlightNode=function(a){"background"in a?(a.node.style.backgroundColor=a.background,a.node.style.color=a.foreground):(a.foreground?a.node.nextSibling.setAttribute("fill",a.foreground):a.node.nextSibling.removeAttribute("fill"),a.node.parentNode.removeChild(a.node))};sre.SvgHighlighter.prototype.isMactionNode=function(a){return a.className.baseVal===this.mactionName};sre.MmlHighlighter=function(){sre.AbstractHighlighter.call(this);this.mactionName="maction"};goog.inherits(sre.MmlHighlighter,sre.AbstractHighlighter);sre.MmlHighlighter.prototype.highlightNode=function(a){var b=a.getAttribute("style"),b=b+(";background-color: "+this.colorString().background),b=b+(";color: "+this.colorString().foreground);a.setAttribute("style",b);return{node:a}};
...
sre.SemanticTree.Node.prototype.mathmlTreeString_=function(){return this.mathmlTree?this.mathmlTree.toString():"EMPTY"};sre.Semantic={};sre.Semantic.Font=sre.SemanticAttr.Font;sre.Semantic.Role=sre.SemanticAttr.Role;sre.Semantic.Type=sre.SemanticAttr.Type;sre.Semantic.getTree=function(a){return(new sre.SemanticTree(a)).xml()};sre.Semantic.getTreeFromString=function(a){a=sre.DomUtil.parseInput(a);return new sre.SemanticTree(a)};sre.EnrichCase=function(){};sre.EnrichCase.prototype.getMathml=function(){};sre.AbstractEnrichCase=function(a){this.semantic=a};sre.EnrichCaseFactory=function(){};sre.EnrichCaseFactory.getEmbellishedCase=function(a){return new sre.EnrichCaseFactory.embellishedCase(a)};sre.EnrichCaseFactory.cases=[];sre.EnrichCaseFactory.getCase=function(a){for(var b=0,c;c=sre.EnrichCaseFactory.cases[b];b++)if(c.test(a))return new c.constr(a);return null};sre.MathSimpleStore=function(){sre.MathStore.call(this)};goog.inherits(sre.MathSimpleStore,sre.MathStore);sre.MathSimpleStore.prototype.defineRulesFromMappings=function(a,b,c){for(var d in c)for(var e in c[d])this.defineRule(a,d+"."+e,'[t] "'+c[d][e]+'"',"self::text()",'"'===b?"self::text() = '"+b+"'":'self::text() = "'+b+'"')};sre.MathCompoundStore=function(){this.subStores_={}};goog.addSingletonGetter(sre.MathCompoundStore);
...
sre.MathMap.retrieveFiles=function(a,b,c){b=sre.SystemExternal.jsonPath+"/"+b;switch(sre.Engine.getInstance().mode){case sre.Engine.Mode.ASYNC:sre.MathMap.toFetch_+=a.length;for(var d=0,e;e=a[d];d++)sre.MathMap.fromFile_(b+e,function(a,b){sre.MathMap.toFetch_--;a||JSON.parse(b).forEach(function(a){c(a)})});break;case sre.Engine.Mode.HTTP:var f=sre.Engine.getInstance().isIE;sre.MathMap.toFetch_+=a.length;for(d=0;e=a[d];d++)f?sre.MathMap.getJsonIE_(e,c):sre.MathMap.getJsonAjax_(b+e,c);break;default:sre.MathMap.parseFiles(a.map(function(a){return b+
...
sre.SemanticTreeRules.getInstance().initializer=[sre.SemanticTreeRules.initCustomFunctions_,sre.SemanticTreeRules.initSemanticRules_];sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNumber=function(a){a=a.textContent.split("");for(var b=[],c=new sre.SystemExternal.xmldom.DOMParser,d=0,e;e=a[d];d++){var f=sre.Semantic.Type.NUMBER,g=e.match(/\W/)?sre.Semantic.Role.UNKNOWN:sre.Semantic.Role.PROTECTED;e=c.parseFromString("<"+f+' role="'+g+'">'+e+"</"+f+">","text/xml");b.push(e.documentElement)}return b};
...
"self::*",'name(../..)="punctuated"','name(../../../..)="tensor"','../../@role="rightsuper"')};sre.PrefixRules.getInstance().initializer=[sre.PrefixRules.initCustomFunctions_,sre.PrefixRules.initPrefixRules_];sre.ClearspeakRules=function(){sre.MathStore.call(this)};goog.inherits(sre.ClearspeakRules,sre.MathStore);goog.addSingletonGetter(sre.ClearspeakRules);sre.ClearspeakRules.mathStore=sre.ClearspeakRules.getInstance();sre.ClearspeakRules.defineRule_=goog.bind(sre.ClearspeakRules.mathStore.defineRule,sre.ClearspeakRules.mathStore);
sre.ClearspeakRules.initClearspeakRules_=function(){(0,sre.ClearspeakRules.defineRule_)("fraction","mathspeak.clearspeak",'[t] "the fraction with numerator"; [n] children/*[1]; [p] (pause:300); [t] "and denominator"; [n] children/*[2]; [p] (pause:500)',"self::fraction");(0,sre.ClearspeakRules.defineRule_)("sqrt","mathspeak.clearspeak",'[t] "the square root of"; [n] children/*[1]; [p] (pause:500)',"self::sqrt")};sre.ClearspeakRules.getInstance().initializer=[sre.ClearspeakRules.initClearspeakRules_];sre.AbstractionRules=function(){sre.MathStore.call(this)};goog.inherits(sre.AbstractionRules,sre.MathStore);goog.addSingletonGetter(sre.AbstractionRules);sre.AbstractionRules.mathStore=sre.AbstractionRules.getInstance();sre.AbstractionRules.defineRule_=goog.bind(sre.AbstractionRules.mathStore.defineRule,sre.AbstractionRules.mathStore);sre.AbstractionRules.defineRuleAlias_=goog.bind(sre.AbstractionRules.mathStore.defineRulesAlias,sre.AbstractionRules.mathStore);
sre.AbstractionRules.defineSpecialisedRule_=goog.bind(sre.AbstractionRules.mathStore.defineSpecialisedRule,sre.AbstractionRules.mathStore);
...
"self::*","self::*");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-continued-fraction","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-sqrt","mathspeak.default",'[t] "collapsed square root"',"self::sqrt[@alternative]");(0,sre.AbstractionRules.defineRule_)("abstr-sqrt","mathspeak.default",'[t] "collapsed nested square root"',"self::sqrt[@alternative]","children/*/descendant::sqrt or children/*/descendant::root");(0,sre.AbstractionRules.defineRule_)("abstr-root",
"mathspeak.default",'[t] "collapsed root of index"; [n] children/*[1]; [t] "endindex"',"self::root[@alternative]","following-sibling::* or ancestor::*/following-sibling::*");(0,sre.AbstractionRules.defineRule_)("abstr-root","mathspeak.brief",'[t] "collapsed root"',"self::root[@alternative]");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-root","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-root","mathspeak.default",'[t] "collapsed nested root of index"; [n] children/*[1]',
"self::root[@alternative]","children/*/descendant::sqrt or children/*/descendant::root");(0,sre.AbstractionRules.defineRule_)("abstr-root","mathspeak.default",'[t] "collapsed nested root of index"; [n] children/*[1]; [t] "endindex"',"self::root[@alternative]","children/*/descendant::sqrt or children/*/descendant::root","following-sibling::* or ancestor::*/following-sibling::*");(0,sre.AbstractionRules.defineRule_)("abstr-root","mathspeak.brief",'[t] "collapsed nested root"',"self::root[@alternative]",
"children/*/descendant::sqrt or children/*/descendant::root");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-root","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-superscript","mathspeak.default",'[t] "collapsed power"',"self::superscript[@alternative]","self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-subscript","mathspeak.default",'[t] "collapsed subscript"',"self::subscript[@alternative]","self::*","self::*","self::*",
"self::*");(0,sre.AbstractionRules.defineRule_)("abstr-subsup","mathspeak.default",'[t] "collapsed power with subscript"',"self::superscript[@alternative]",'name(children/*[1])="subscript"',"self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-infixop","mathspeak.default",'[t] "collapsed"; [t] @role; [t] "with"; [t] count(./children/*); [t] "elements"',"self::infixop[@alternative]","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-infixop","mathspeak.default",'[t] "collapsed"; [t] @role; [t] "with variable number of elements"',
...
"mathspeak.default",'[t] "collapsed"; [n] content/*[1]; [t] "separated list";[t] "of variable length"',"self::punctuated[@alternative]",'./children/punctuation[@role="ellipsis"]');(0,sre.AbstractionRules.defineRule_)("abstr-text","mathspeak.default",'[t] "collapsed text"',"self::text[@alternative]");(0,sre.AbstractionRules.defineRule_)("abstr-bigop","mathspeak.default",'[t] "collapsed"; [n] content/*[1]',"self::relseq[@alternative]","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-relation",
"mathspeak.brief",'[t] "collapsed"; [n] text(); [t] "sequence"',"self::relseq[@alternative]","count(./children/*)=2");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-relation","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-relation","mathspeak.default",'[t] "collapsed"; [n] text(); [t] "sequence"; [t] "with"; [t] count(./children/*); [t] "elements"',"self::relseq[@alternative]","count(./children/*)>2");(0,sre.AbstractionRules.defineRule_)("abstr-relation",
"mathspeak.brief",'[t] "collapsed"; [n] text(); [t] "sequence"',"self::relseq[@alternative]","count(./children/*)>2");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-relation","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-var-relation","mathspeak.default",'[t] "collapsed"; [n] text(); [t] "sequence"; [t] "with variable number of elements"',"self::relseq[@alternative]","count(./children/*)>2",'./children/punctuation[@role="ellipsis"]');(0,sre.AbstractionRules.defineRule_)("abstr-equality",
"mathspeak.default",'[t] "collapsed equation"',"self::relseq[@alternative]",'self::relseq[@role="equality"]',"count(./children/*)=2");(0,sre.AbstractionRules.defineRule_)("abstr-equality","mathspeak.default",'[t] "collapsed equation sequence"; [t] "with"; [t] count(./children/*); [t] "elements"',"self::relseq[@alternative]",'self::relseq[@role="equality"]',"count(./children/*)>2");(0,sre.AbstractionRules.defineRule_)("abstr-equality","mathspeak.brief",'[t] "collapsed equation sequence";',"self::relseq[@alternative]",
'self::relseq[@role="equality"]',"count(./children/*)>2");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-equality","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-var-equality","mathspeak.default",'[t] "collapsed equation sequence with variable number of elements"',"self::relseq[@alternative]",'self::relseq[@role="equality"]',"count(./children/*)>2",'./children/punctuation[@role="ellipsis"]');(0,sre.AbstractionRules.defineRule_)("abstr-multirel","mathspeak.default",
'[t] "collapsed relation sequence"; [t] "with"; [t] count(./children/*); [t] "elements"',"self::multirel[@alternative]","count(./children/*)>2");(0,sre.AbstractionRules.defineRule_)("abstr-multirel","mathspeak.brief",'[t] "collapsed relation sequence"',"self::multirel[@alternative]","count(./children/*)>2");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-multirel","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-var-multirel","mathspeak.default",'[t] "collapsed relation sequence with variable number of elements"',
"self::multirel[@alternative]","count(./children/*)>2",'./children/punctuation[@role="ellipsis"]')};sre.AbstractionRules.getInstance().initializer=[sre.AbstractionRules.initAbstractionRules_];sre.MathspeakRules=function(){sre.MathStore.call(this)};goog.inherits(sre.MathspeakRules,sre.MathStore);goog.addSingletonGetter(sre.MathspeakRules);sre.MathspeakRules.mathStore=sre.MathspeakRules.getInstance();sre.MathspeakRules.defineRule_=goog.bind(sre.MathspeakRules.mathStore.defineRule,sre.MathspeakRules.mathStore);sre.MathspeakRules.defineRuleAlias_=goog.bind(sre.MathspeakRules.mathStore.defineRulesAlias,sre.MathspeakRules.mathStore);
...
sre.EnrichMathml.enrich=function(a,b){sre.Engine.getInstance().speech&&sre.EnrichMathml.computeSpeech(b.xml());var c=a.cloneNode(!0);sre.EnrichMathml.walkTree(b.root);sre.Debugger.getInstance().generateOutput(function(){sre.EnrichMathml.formattedOutput(c,a,b,!0);return[]});return a};
...
b.parent&&a.setAttribute(sre.EnrichMathml.Attribute.PARENT,b.parent.id);b.embellished&&a.setAttribute(sre.EnrichMathml.Attribute.EMBELLISHED,b.embellished);b.fencePointer&&a.setAttribute(sre.EnrichMathml.Attribute.FENCEPOINTER,b.fencePointer);sre.Engine.getInstance().speech&&(sre.EnrichMathml.addSpeech(a,b),sre.EnrichMathml.addPrefix(a,b))};
...
sre.EnrichMathml.removeAttributePrefix=function(a){return a.toString().replace(new RegExp(sre.EnrichMathml.ATTRIBUTE_PREFIX_,"g"),"")};sre.EnrichMathml.printNodeList__=function(a,b){console.log(a);sre.DomUtil.toArray(b).forEach(function(a){console.log(a.toString())});console.log("<<<<<<<<<<<<<<<<<")};sre.EnrichMathml.computeSpeech=function(a){var b=sre.SpeechRuleEngine.getInstance();b.clearCache();return b.evaluateNode(a)};
sre.EnrichMathml.recomputeSpeech=function(a,b){var c=sre.SemanticTree.fromNode(b);return sre.SpeechRuleEngine.getInstance().evaluateNode(c.xml())};sre.EnrichMathml.addSpeech=function(a,b){var c=sre.SpeechRuleEngine.getInstance().getCache(b.id.toString());c||(c=sre.EnrichMathml.recomputeSpeech(a,b));c=sre.AuditoryDescription.speechString(c);a.setAttribute(sre.EnrichMathml.Attribute.SPEECH,c)};
sre.EnrichMathml.addPrefix=function(a,b){var c=sre.EnrichMathml.computePrefix_(b);(c=sre.AuditoryDescription.speechString(c))&&a.setAttribute(sre.EnrichMathml.Attribute.PREFIX,c)};
sre.EnrichMathml.computePrefix_=function(a){var b=sre.SemanticTree.fromRoot(a),c=sre.XpathUtil.evalXPath('.//*[@id="'+a.id+'"]',b.xml())[0];return c?sre.SpeechRuleEngine.getInstance().runInSetting({domain:"prefix",style:"default",strict:!0,cache:!1,speech:!0,rules:["PrefixRules"]},function(){return sre.SpeechRuleEngine.getInstance().evaluateNode(c)}):[]};
sre.EnrichMathml.connectMactions=function(a,b,c){b=sre.DomUtil.querySelectorAll(b,"maction");for(var d=0,e;e=b[d];d++){var f=e.getAttribute("id");if(f=sre.DomUtil.querySelectorAllByAttrValue(a,"id",f)[0]){var g=e.childNodes[1];e=g.getAttribute(sre.EnrichMathml.Attribute.ID);var h=sre.WalkerUtil.getBySemanticId(a,e);h&&"dummy"!==h.getAttribute(sre.EnrichMathml.Attribute.TYPE)||(h=f.childNodes[0],(f=g.getAttribute(sre.EnrichMathml.Attribute.PARENT))&&h.setAttribute(sre.EnrichMathml.Attribute.PARENT,
f),h.setAttribute(sre.EnrichMathml.Attribute.TYPE,"dummy"),h.setAttribute(sre.EnrichMathml.Attribute.ID,e),sre.DomUtil.querySelectorAllByAttrValue(c,"id",e)[0].setAttribute("alternative",e))}}};sre.EnrichMathml.connectAllMactions=function(a,b){for(var c=sre.DomUtil.querySelectorAll(a,"maction"),d=0,e;e=c[d];d++)e.getAttribute("id"),e=e.childNodes[1].getAttribute(sre.EnrichMathml.Attribute.ID),sre.DomUtil.querySelectorAllByAttrValue(b,"id",e)[0].setAttribute("alternative",e)};sre.CaseDoubleScript=function(a){sre.AbstractEnrichCase.call(this,a);this.mml=a.mathmlTree};goog.inherits(sre.CaseDoubleScript,sre.AbstractEnrichCase);sre.CaseDoubleScript.test=function(a){if(!a.mathmlTree)return!1;var b=sre.SemanticUtil.tagName(a.mathmlTree);return"MSUBSUP"===b&&a.type===sre.SemanticAttr.Type.SUPERSCRIPT||"MUNDEROVER"===b&&a.type===sre.SemanticAttr.Type.OVERSCORE};
...
sre.RebuildStree.collapsedChildren_=function(a,b,c){b.unshift(a);b=b.concat(a.childNodes);var d={};a=0;for(var e;e=b[a];a++)d[e.id]=e;var f=function(a){var b=d[a[0]];b.childNodes=[];for(var c=1,e=a.length;c<e;c++)"number"===typeof a[c]?b.childNodes.push(d[a[c]]):b.childNodes.push(f(a[c]));return b};f(c)};sre.RebuildStree.parseCollapsed_=function(a){a=a.replace(/\(/g,"[");a=a.replace(/\)/g,"]");a=a.replace(/ /g,",");return JSON.parse(a)};
sre.RebuildStree.experiment__=function(a){var b=sre.DomUtil.parseInput("<math>"+a+"</math>"),c=new sre.SemanticTree(b);a=c.toString();b=sre.EnrichMathml.enrich(b,c);b=(new sre.RebuildStree(b)).toString();return a===b};sre.WalkerUtil={};sre.WalkerUtil.splitAttribute=function(a){return a?a.split(/,/):[]};
...
sre.WalkerUtil.getBySemanticId=function(a,b){return a.querySelector?a.querySelector("["+sre.EnrichMathml.Attribute.ID+'="'+b+'"]'):sre.XpathUtil.evalXPath(".//*[@"+sre.EnrichMathml.Attribute.ID+'="'+b+'"]',a)[0]};sre.SpeechGeneratorInterface=function(){};sre.SpeechGeneratorInterface.prototype.getSpeech=function(a,b){};sre.SpeechGeneratorInterface.prototype.getRebuilt=function(){};sre.SpeechGeneratorInterface.prototype.setRebuilt=function(a){};sre.SpeechGeneratorInterface.prototype.start=function(){};sre.SpeechGeneratorInterface.prototype.end=function(){};sre.AbstractSpeechGenerator=function(){this.rebuilt_=null};sre.AbstractSpeechGenerator.prototype.getRebuilt=function(){return this.rebuilt_};sre.AbstractSpeechGenerator.prototype.setRebuilt=function(a){this.rebuilt_=a};sre.AbstractSpeechGenerator.prototype.start=function(){};sre.AbstractSpeechGenerator.prototype.end=function(){};sre.AbstractSpeechGenerator.prototype.generateSpeech=function(a,b){var c=sre.EnrichMathml.computeSpeech(this.getRebuilt().xml);return sre.AuditoryDescription.speechString(c)};sre.DirectSpeechGenerator=function(){sre.AbstractSpeechGenerator.call(this)};goog.inherits(sre.DirectSpeechGenerator,sre.AbstractSpeechGenerator);sre.DirectSpeechGenerator.prototype.getSpeech=function(a,b){return sre.WalkerUtil.getAttribute(a,sre.EnrichMathml.Attribute.SPEECH)};sre.Focus=function(a){this.nodes_=a.nodes?a.nodes:[];this.primary_=a.primary?a.primary:null};sre.Focus.prototype.getNodes=function(){return this.nodes_};sre.Focus.prototype.getPrimary=function(){return this.primary_};sre.Focus.prototype.toString=function(){return"Primary:"+this.primary_+" Nodes:"+this.nodes_};sre.EventUtil={};sre.EventUtil.KeyCode={RETURN:13,ENTER:13,ESC:27,SPACE:32,LEFT:37,UP:38,RIGHT:39,DOWN:40,TAB:9,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90};
...
sre.AbstractWalker.prototype.deactivate=function(){this.isActive()&&(this.highlighter.setState(this.node.id,this.primaryId()),this.generator.end(),this.toggleActive_())};sre.AbstractWalker.prototype.getFocus=function(){return this.focus_};
...
sre.SemanticWalker.prototype.right=function(){sre.SemanticWalker.superClass_.right.call(this);var a=this.levels.indexOf(this.getFocus())+1;return(a=this.levels.get(a))?a:null};sre.SemanticWalker.prototype.getDepth=function(){return this.levels.depth()-1};sre.SemanticWalker.prototype.findFocusOnLevel=function(a){return this.levels.find(function(b){b=b.getPrimary();return sre.WalkerUtil.getAttribute(b,sre.EnrichMathml.Attribute.ID)===a.toString()})};sre.System=function(){this.version="0.8";this.speechGenerator=this.walker=null;this.defaultRuleSets_="MathmlStoreRules SemanticTreeRules MathspeakRules ClearspeakRules AbstractionRules PrefixRules".split(" ")};goog.addSingletonGetter(sre.System);sre.System.Error=function(a){Error.call(this);this.message=a||"";this.name="System Error"};goog.inherits(sre.System.Error,Error);
sre.System.prototype.setupEngine=function(a){var b=sre.Engine.getInstance();b.mode=a.mode||b.mode;sre.System.prototype.configBlocks_(a);b.style=a.style||b.style;b.domain=a.domain||b.domain;b.ssml=!!a.ssml;b.strict=!!a.strict;b.semantics=!!a.semantics;void 0!==a.cache&&(b.cache=!!a.cache);b.speech=!!a.speech;a.json&&(sre.SystemExternal.jsonPath=a.json);a.xpath&&(sre.SystemExternal.WGXpath=a.xpath);b.setupBrowsers();a.rules?b.setRuleSets(a.rules):b.setRuleSets(this.defaultRuleSets_);sre.SpeechRuleEngine.getInstance().parameterize(b.getRuleSets());
...
sre.System.prototype.toSpeech=function(a){return(a=sre.System.getInstance().parseExpression_(a,sre.Engine.getInstance().semantics))?sre.System.getInstance().processXml(a):""};sre.System.prototype.processExpression=sre.System.prototype.toSpeech;sre.System.prototype.toSemantic=function(a){return(a=sre.System.getInstance().parseExpression_(a,!0))?a.toString():""};
sre.System.prototype.toJson=function(a){return(a=sre.System.getInstance().parseExpression_(a,!0))?sre.SystemExternal.xm.tojson(a.toString()):{}};sre.System.prototype.toDescription=function(a){a=sre.System.getInstance().parseExpression_(a,sre.Engine.getInstance().semantics);if(!a)return[];a=sre.EnrichMathml.computeSpeech(a);sre.AuditoryDescription.preprocessDescriptionList(a);return a};sre.System.prototype.toEnriched=function(a){return(a=sre.Enrich.semanticMathmlSync(a))?a.toString():""};
...
sre.System.prototype.fileToDescription=function(a,b){sre.System.getInstance().processFile_(function(a){return JSON.stringify(sre.System.getInstance().toDescription(a))},a,b)};sre.System.prototype.fileToEnriched=function(a,b){sre.System.getInstance().processFile_(sre.System.getInstance().toEnriched,a,b)};sre.System.prototype.processXml=function(a){a=sre.EnrichMathml.computeSpeech(a);return sre.AuditoryDescription.speechString(a)};
...
sre.System.prototype.walk=function(a){this.speechGenerator=new sre.DirectSpeechGenerator;var b=new sre.MmlHighlighter;sre.System.getInstance().parseExpression_(a,!1);sre.Engine.getInstance().speech=!0;a=sre.System.getInstance().toEnriched(a);var c=sre.DomUtil.parseInput(a,sre.System.Error);this.walker=new sre.SyntaxWalker(c,this.speechGenerator,b,a);return this.walker.speech()};sre.System.prototype.move=function(a){return!1===this.walker.move(a)?null:this.walker.speech()};sre.Api={};sre.Api.toSpeech=function(a){return sre.System.getInstance().toSpeech(a)};module.exports.processExpression=sre.Api.toSpeech;module.exports.toSpeech=sre.Api.toSpeech;module.exports.toSemantic=sre.System.getInstance().toSemantic;module.exports.toJson=sre.System.getInstance().toJson;module.exports.toDescription=sre.System.getInstance().toDescription;module.exports.toEnriched=sre.System.getInstance().toEnriched;module.exports.walk=sre.System.getInstance().walk;module.exports.move=sre.System.getInstance().move;
module.exports.file={};module.exports.file.toSpeech=sre.System.getInstance().fileToSpeech;module.exports.processFile=sre.System.getInstance().fileToSpeech;module.exports.file.toSemantic=sre.System.getInstance().fileToSemantic;module.exports.file.toJson=sre.System.getInstance().fileToJson;module.exports.file.toDescription=sre.System.getInstance().fileToDescription;module.exports.file.toEnriched=sre.System.getInstance().fileToEnriched;
module.exports.setupEngine=goog.bind(sre.System.getInstance().setupEngine,sre.System.getInstance());module.exports.pprintXML=sre.DomUtil.formatXml;sre.System.getInstance().setupEngine({mode:sre.Engine.Mode.ASYNC});
